...
function FAQItemComponent({ item }: FAQItemProps) {
  ...
  return (
    <Card
      className="border border-border bg-background overflow-hidden transition-all duration-200"
...
export function LandingFAQ() {
  return (
    <section id="faq" className="border-b border-border bg-background py-24 sm:py-32">
