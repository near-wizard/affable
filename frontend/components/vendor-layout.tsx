  ...
  return (
    <div className="flex h-screen">
      ...
      >
        ...
        {/* Main content area with onboarding checklist */}
        <div className="flex-1 overflow-auto pb-20 md:pb-0 bg-background relative">
          {/* Onboarding Checklist - positioned fixed on right for desktop */}
          <div className="hidden lg:block fixed top-20 right-6 w-80 max-h-96 z-30">
            <OnboardingChecklist />
          </div>

          {/* Mobile onboarding checklist - full width */}
          <div className="lg:hidden p-4">
            <OnboardingChecklist />
          </div>

          {/* Main content with padding for checklist */}
          <main className="px-4 py-6 lg:pr-96">
            {children}
          </main>
          ...
          <button
            ...
            className="fixed bottom-6 right-6 p-3 rounded-full bg-red-500 hover:bg-red-600 text-white shadow-lg transition-colors z-20"
            title="Report a bug"
          >
            <svg
            ...
            >
              ...
              <path d="M12 1v6m6-6v6M6 7v6"></path>
