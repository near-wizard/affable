...
export default function CoursePage() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-[calc(100vh-4rem)] bg-gradient-to-br from-slate-50 to-blue-50">
      {/* Sidebar */}
      <aside className="md:w-80 w-full border-r border-border bg-white/80 backdrop-blur-sm p-6 overflow-y-auto shadow-lg">
        <Button
          variant="ghost"
          size="sm"
          onClick={() => router.push("/academy")}
          className="mb-6 flex items-center gap-2 text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
        >
        ...
        <div className="space-y-4 mb-6">
          <div>
            <h2 className="font-bold text-lg text-foreground mb-2">{courseData.title}</h2>
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center text-xs text-muted-foreground">
              ...
              <span className="bg-primary/10 text-primary px-2 py-1 rounded-full font-bold">{Math.round(progress)}%</span>
            </div>
        ...
        <div className="border-t border-border pt-4">
          <h3 className="font-semibold text-foreground mb-3 text-sm uppercase tracking-wider">Lessons</h3>
        ...
        <div className="max-w-4xl mx-auto">
          {activeLesson ? (
            <>
              <div className="mb-8 space-y-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <span className="text-xs font-bold text-primary uppercase tracking-wider">Lesson</span>
                </div>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-border shadow-xl hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="flex flex-col items-center justify-center h-96 text-center">
              ...
              <p className="text-lg text-muted-foreground">Select a lesson to begin learning.</p>
            </div>
          )}
        </div>
      </main>
