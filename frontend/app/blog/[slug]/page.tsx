      ...
      <div className="relative z-10">
        ...
        <header className="border-b border-slate-700 backdrop-blur-md">
          <div className="max-w-4xl mx-auto px-4 sm:px-8 py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <span className="px-4 py-2 bg-primary/100/20 text-blue-300 text-xs font-bold rounded-full border border-blue-400/30">
                    {post.category}
                  </span>
            ...
            <div className="flex flex-wrap items-center gap-6 text-sm text-muted-foreground pt-6 border-t border-slate-700">
        ...
        <main className="max-w-4xl mx-auto px-4 sm:px-8 py-16">
          ...
          <div className="mt-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/"
                className="inline-flex items-center justify-center gap-2 bg-white text-primary px-8 py-3 rounded-lg font-semibold hover:bg-primary/10 transition-all"
              >
                Try AffableLink
              </Link>
              <Link
