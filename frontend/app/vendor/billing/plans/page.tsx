...
export default function PlansPage() {
  ...
  const isCurrentPlan = (planId: string) => planId === currentSubscription?.plan_id;
        ...
        {loading ? (
          ...
          <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        type="number"
                        value={gmvAmount}
                        onChange={(e) => setGmvAmount(Math.max(0, parseInt(e.target.value) || 0))}
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <ul className="space-y-2">
                          {(PLAN_FEATURES[plan.name] || []).map((feature, idx) => (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y">
                      <tr>
                        <td className="py-3 px-4 font-semibold text-slate-900">Base Price</td>
                        {plans.map((plan) => (
                      ...
                      <tr>
                        <td className="py-3 px-4 font-semibold text-slate-900">GMV Fee</td>
                        {plans.map((plan) => (
                          <td key={plan.id} className="text-center py-3 px-4">
                            {plan.gmv_percentage}%
                          </td>
                      ...
                      <tr className="bg-slate-50">
                        <td className="py-3 px-4 font-semibold text-slate-900">Analytics</td>
                        {plans.map((plan, idx) => (
                          <td key={plan.id} className="text-center py-3 px-4">
                            {idx === plans.length - 1 ? (
                              <span className="text-slate-900 font-semibold">Real-time</span>
                            ) : idx === 0 ? (
                      ...
                      <tr>
                        <td className="py-3 px-4 font-semibold text-slate-900">Support</td>
                        {plans.map((plan, idx) => (
                          <td key={plan.id} className="text-center py-3 px-4">
                            {idx === plans.length - 1 ? (
                      ...
                      <tr className="bg-slate-50">
                        <td className="py-3 px-4 font-semibold text-slate-900">SLA</td>
                        {plans.map((plan, idx) => (
                          <td key={plan.id} className="text-center py-3 px-4">
                            {idx === plans.length - 1 ? (
                              <Check className="h-5 w-5 text-green-600 mx-auto" />
            ...
            <Alert className="bg-blue-50 border-blue-200">
              ...
              <AlertDescription>
                Plan changes take effect immediately. Pricing is prorated based on your billing cycle.
                You can change your plan anytime with no penalties.
              </AlertDescription>
            </Alert>
          </div>
        )}
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="font-semibold">{selectedPlan?.display_name}</span>. This change will
