...
class ConversionEvent(BaseModel):
    ...
    conversion_event_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
    ...
    click_id = Column(Integer, ForeignKey("clicks.click_id"), index=True)
...
class Touch(BaseModel):
    ...
    touch_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
    conversion_event_id = Column(Integer, ForeignKey("conversion_events.conversion_event_id"), index=True)
    lead_id = Column(Integer, ForeignKey("leads.lead_id"))
...
class Lead(BaseModel):
    ...
    lead_id = Column(Integer, primary_key=True, autoincrement=True, index=True)
